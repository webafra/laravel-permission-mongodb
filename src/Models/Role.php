...
namespace Webafra\Permission\Models;

use Illuminate\Database\Eloquent\Builder;
use Jenssegers\Mongodb\Eloquent\Model;
use Webafra\Permission\Contracts\PermissionInterface;
use Webafra\Permission\Contracts\RoleInterface;
use Webafra\Permission\Exceptions\GuardDoesNotMatch;
use Webafra\Permission\Exceptions\RoleAlreadyExists;
use Webafra\Permission\Exceptions\RoleDoesNotExist;
use Webafra\Permission\Guard;
use Webafra\Permission\Helpers;
use Webafra\Permission\Traits\HasPermissions;
use Webafra\Permission\Traits\RefreshesPermissionCache;
 ...
 * Class Role
 * @property string $_id
 * @package Webafra\Permission\Models
 */
