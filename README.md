...
The `assignRole`, `hasRole`, `hasAnyRole`, `hasAllRoles`  and `removeRole` functions can accept a
 string, a `\Webafra\Permission\Models\Role` object or an `\Illuminate\Support\Collection` object.
...
string or a `Webafra\Permission\Models\Permission` object.
...
If you discover any security-related issues, please email webafra@gmail.com instead of using the issue tracker.
